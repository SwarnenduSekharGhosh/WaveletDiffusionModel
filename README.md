...
- A Wavelet Diffusion Transaformer framework for MA detection (WDT-MD)
  ...
  - Pseudo-normal pattern synthesis via inpainting to introduce pixel-level supervision. This enables discrimination between MA(Microaneurysms) and other anomalies.
